        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-line-chart"></i> <span>PT IT Stock</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a data-toggle="tooltip" data-placement="bottom"><i class="fa fa-file-text-o"></i> Purchase Order <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <?php if($_SESSION['ssUserStatus'] == '2' || $_SESSION['ssUserStatus'] == '0') { ?>
