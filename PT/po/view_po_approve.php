...
<section class="content invoice">
    ...
    <div class="row">
        ...
        <center>
        <br>
            <?php if($rowpov['PoStatus'] == 1  &&  $_SESSION['ssUserStatus'] == 3) { ?>
            <button type="button" class="btn btn-xs btn-primary" onclick="javascript:apppo(<?=$_POST['id']?>);" > <- อนุมัติ -> </button>
            <?php }else{ ?>
        ...
        <!-- /.col -->
        <div class="col-sm-4">
        <?php if($rowpov['PoPriceTotal'] >= 5001.00){ ?>
        <center>
        <br>
        <?php $sql_w = 'SELECT * FROM apprname_tb WHERE ApprID = "'.$rowpov['PoApprName'].'" ';
            $rs = mysql_query($sql_w) or die(mysql_error());
            $rw = mysql_fetch_array($rs);?>
            .................................... <br>
            <h4><?php echo $rw['ApprName']; ?></h4>
            <h4><?php echo $rw['ApprPosition'];?> </h4>
