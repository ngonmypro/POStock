                          ...
                          <address>
                                <strong>
                                    ...
                                    <select class="form-control" id="compo">
                                        <option value="1">บจก.พร้อมขนส่ง จำกัด</option>         
                                    </select>
                                    </div>
                                </strong>
                                <div class="col-sm-7 invoice-col">
...
function savepo() {
  ...
  var data = "compo=" + compo + "&brahpo=" + brahpo + "&suppo=" + suppo + "&pochnum=" + pochnum +"&detailpo=" + detailpo;
      data += "&sumpa=" + sumpa + "&sumnvat=" + sumnvat + "&sumvat=" + sumvat + "&sumtotal=" + sumtotal + "&apprna=" + apprna;
	//alert(data);
	if(compo != '' && brahpo != '' && suppo != '' && pochnum != '' && apprna != ''){
	$.ajax({
		type: "POST",
