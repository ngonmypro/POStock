...
<div class="form-horizontal form-label-left" >
  ...
  <div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="useru"> </label>
    <div class="col-md-6 col-sm-6 col-xs-12">
      <input type="text" id="detailqe"  class="form-control col-md-7 col-xs-12" onKeyUp="ekeyup1();" value="<?php echo $rows['ListDetail'] ?>" >
    </div>
  </div>
  <div class="form-group">
