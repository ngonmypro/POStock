...
function addlist() {
  ...
  al += '<td  style="width: 50%"><select class="selectpicker" data-live-search="true" id="item'+i+'" hidden>';
...
function list_new() {
  ...
  for (var li2 = 1; li2 <= it ; li2++) {
    data = "item=" + item[li2] + "&numb=" + numb[li2] + "&unit=" + unit[li2] + "&prict=" + prict[li2] + "&dis2=" + dis2[li2] + "&ptotal=" + ptotal[li2];
    //alert(data);
    $.ajax({
		type: "POST",
