...
$date = Date("Ymd_his");
$sql_lk = 'INSERT INTO mainbeg_tb (MbegID, Mbeg_UserbID, MbegCode, MbegDate, MbegStatus, MbegAddTime, MbegAddUser, MbegEditTime, MbegEditUser) VALUE ( NULL, "'.$rr.'", "'.$date.'", NOW(), "0", NOW(), "'.$_SESSION['ssUserName'].'", NOW(), "'.$_POST['ssUserName'].'" ) ';
