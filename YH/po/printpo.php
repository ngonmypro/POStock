...
<?php $sql1 = 'SELECT * FROM list_tb,product_tb WHERE List_PoID = "'.$row['PoID'].'" and List_ProdID = ProdID ';
    ...
    <table>
		...
		$ponameall = /*$row1['ProdName'] . " " . */$row1['ListDetail'];
	?>
            <tr>
                <td class="code fontsize" ><?php echo ++$i;?></td>
                <td class="product fontsize"><?=$ponameall?></td>
...
<div class="name2">คุณเอกราช ปิ่นเงิน</div>
...
<div class="date1"><?php echo DateThai($row['PoDate']); ?></div>
<div class="name2d">คุณเอกราช ปิ่นเงิน</div>
<?php } ?>
<?php } ?>
</page>
</body>
