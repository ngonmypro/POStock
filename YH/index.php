...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="menu_section">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a data-toggle="tooltip" data-placement="bottom"><i class="fa fa-file"></i> Summary <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="javascript:summary();">Show Summary</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
    ...
    <script src="../vendors/lobipanel/dist/js/lobipanel.js"></script>
     <script src="../vendors/jQuery.dotdotdot-master/dist/jquery.dotdotdot.js"></script>                   
    <!-- bootstrap-dialog -->
