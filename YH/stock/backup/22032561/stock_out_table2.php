...
<table class="table table-striped table-bordered" id="begstock">
    ...
    <?php $sql_o = 'SELECT * FROM mainbeg_tb,user_tb,branch_tb,dep_tb WHERE Mbeg_UserbID = UserID and UserBrah = BrahCode and UserDep = DepID and MbegStatus = 1';
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <button type="button" class="btn btn-xs btn-primary" onclick="javascript:begconf2(<?=$rowo['MbegID']?>);" ><span class="fa fa-eye" ></span> View</button>
            </td>
        </tr>
        <?php } ?>
    </tbody>
