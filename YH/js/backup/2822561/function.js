...
function supply_edit(id) {
	...
	if(supn != ''){
		$.ajax({
			type : 'POST',
			url : 'supplier/edit_supplier.php',
			cache : false,
			data : data,
			success : function (msg) {
				if(msg != ''){
...
function addlistedpo(chk,id,id2) {
	...
	var data = 'edpoduct=' + edpoduct + '&numeee=' + numeee + '&cunitee=' + cunitee + '&prieee=' + prieee + '&diseee=' + diseee + '&totaleee=' + totaleee + '&id=' + id + '&id2=' + id2 + '&chk=' + chk;
...
function edposave(id) {
	...
	var data = 'brahpo=' + brahpo + '&suppo=' + suppo + '&poeddet=' + poeddet + '&sumpaee=' + sumpaee + '&sumnvatee=' + sumnvatee + '&sumvatee=' + sumvatee + '&sumtotalee=' + sumtotalee + '&id=' + id; 
	if(brahpo != '' && suppo != '' && poeddet != '' && sumpaee != '' && sumnvatee != '' && sumvatee != '' && sumtotalee != ''){
		$.ajax({
			type : 'POST',
